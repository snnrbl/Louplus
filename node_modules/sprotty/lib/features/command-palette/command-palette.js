...
var CommandPalette = /** @class */ (function (_super) {
    ...
    function CommandPalette() {
        ...
        _this.actionsLoadingClass = "autocomplete-loading";
        _this.xOffset = 20;
        _this.yOffset = 20;
        _this.defaultWidth = 400;
        _this.debounceWaitMs = 200;
        return _this;
    }
    ...
    CommandPalette.prototype.updateAutoCompleteActions = function (update, text, root) {
        ...
        if (this.contextActions) {
            ...
            this.actionProviderRegistry.getActions(root, text, this.mousePositionTracker.lastPositionOnDiagram)
                ...
                _this.inputElement.classList.remove(_this.actionsLoadingClass);
            })
    ...
    CommandPalette.prototype.renderLabeledActionSuggestion = function (item, value) {
        ...
        var wordMatcher = value.split(" ").join("|");
