...
var YangLanguageClientContribution = /** @class */ (function (_super) {
    ...
    function YangLanguageClientContribution(workspace, languages, languageClientFactory, diagramManagerProviders, semanticHighlightingService) {
    ...
    Object.defineProperty(YangLanguageClientContribution.prototype, "documentSelector", {
        get: function () {
            return [
                this.id
            ];
    ...
    YangLanguageClientContribution = __decorate([
        ...
        __param(3, inversify_1.multiInject(lib_1.DiagramManagerProvider)),
        __param(4, inversify_1.inject(semantic_highlighting_service_1.SemanticHighlightingService)),
        __metadata("design:paramtypes", [Object, Object, browser_1.LanguageClientFactory, Array, semantic_highlighting_service_1.SemanticHighlightingService])
    ], YangLanguageClientContribution);
    return YangLanguageClientContribution;
}(lib_1.DiagramLanguageClientContribution));
