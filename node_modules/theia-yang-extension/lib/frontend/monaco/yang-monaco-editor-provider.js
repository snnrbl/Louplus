...
var YangMonacoEditorProvider = /** @class */ (function (_super) {
    ...
    function YangMonacoEditorProvider(editorService, monacoModelResolver, contextMenuService, m2p, p2m, workspace, commandServiceFactory, editorPreferences, quickOpenService, diffNavigatorFactory, applicationServer, contextKeyService) {
        var _this = _super.call(this, editorService, monacoModelResolver, contextMenuService, m2p, p2m, workspace, commandServiceFactory, editorPreferences, quickOpenService, diffNavigatorFactory, applicationServer, contextKeyService) || this;
        ...
        _this.applicationServer = applicationServer;
