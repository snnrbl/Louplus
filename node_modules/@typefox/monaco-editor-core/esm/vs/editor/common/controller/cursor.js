    ...
    Cursor.prototype._executeEditOperation = function (opResult) {
        ...
        if (result) {
            ...
            if (autoClosedCharactersRanges.length > 0) {
                var autoClosedCharactersDecorations = this._model.deltaDecorations([], autoClosedCharactersRanges);
                var autoClosedEnclosingDecorations = this._model.deltaDecorations([], autoClosedEnclosingRanges);
    ...
    Cursor.prototype._type = function (source, text) {
        if (!this._isDoingComposition && source === 'keyboard') {
            ...
            for (var i = 0, len = text.length; i < len; i++) {
                ...
                if (this._autoClosedActions.length > 0) {
                    for (var i_1 = 0, len_1 = this._autoClosedActions.length; i_1 < len_1; i_1++) {
                        autoClosedCharacters = autoClosedCharacters.concat(this._autoClosedActions[i_1].getAutoClosedCharactersRanges());
                    }
                }
