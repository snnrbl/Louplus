...
import { ReplaceCommand, ReplaceCommandWithOffsetCursorState, ReplaceCommandWithoutChangingPosition } from '../commands/replaceCommand';
...
var TypeOperations = /** @class */ (function () {
    ...
    TypeOperations._isAutoClosingCloseCharType = function (config, model, selections, autoClosedCharacters, ch) {
...
var TypeWithAutoClosingCommand = /** @class */ (function (_super) {
    ...
    function TypeWithAutoClosingCommand(selection, openCharacter, closeCharacter) {
        var _this = _super.call(this, selection, openCharacter + closeCharacter, 0, -closeCharacter.length) || this;
