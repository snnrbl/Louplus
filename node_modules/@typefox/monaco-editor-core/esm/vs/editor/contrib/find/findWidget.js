...
var FindWidget = /** @class */ (function (_super) {
    ...
    FindWidget.prototype._buildDomNode = function () {
        ...
        this._register(this._preserveCase.onChange(function (viaKeyboard) {
            if (!viaKeyboard) {
                _this._state.change({ preserveCase: !_this._state.preserveCase }, false);
                _this._replaceInputBox.focus();
            }
        }));
        // Replace one button
