            ...
            _this._editor.changeViewZones(function (viewZoneAccessor) {
                ...
                while (groupsIndex < groups.length && codeLensIndex < _this._lenses.length) {
                    ...
                    if (codeLensLineNumber < symbolsLineNumber) {
                        ...
                        _this._lenses.splice(codeLensIndex, 0, new CodeLensWidget(groups[groupsIndex], _this._editor, helper, viewZoneAccessor, function () { return _this._detectVisibleLenses.schedule(); }));
                        codeLensIndex++;
                        groupsIndex++;
                    }
                }
                ...
                while (groupsIndex < groups.length) {
                    _this._lenses.push(new CodeLensWidget(groups[groupsIndex], _this._editor, helper, viewZoneAccessor, function () { return _this._detectVisibleLenses.schedule(); }));
                    groupsIndex++;
                }
                helper.commit(decorationsAccessor);
            });
