...
var WorkbenchList = /** @class */ (function (_super) {
    ...
    function WorkbenchList(container, delegate, renderers, options, contextKeyService, listService, themeService, configurationService, keybindingService) {
        ...
        _this = _super.call(this, container, delegate, renderers, __assign({ keyboardSupport: false, styleController: new DefaultStyleController(getSharedListStyleSheet()) }, computeStyles(themeService.getTheme(), defaultListStyles), workbenchListOptions, { horizontalScrolling: horizontalScrolling })) || this;
        ...
        _this.disposables.add(attachListStyler(_this, themeService));
...
var TreeResourceNavigator2 = /** @class */ (function (_super) {
    __extends(TreeResourceNavigator2, _super);
