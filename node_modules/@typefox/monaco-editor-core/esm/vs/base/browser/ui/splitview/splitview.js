...
var ViewItem = /** @class */ (function () {
    ...
    ViewItem.prototype.layoutView = function (orientation) {
...
var VerticalViewItem = /** @class */ (function (_super) {
    ...
    VerticalViewItem.prototype.layout = function () {
        this.container.style.height = this.size + "px";
        this.layoutView(0 /* VERTICAL */);
    };
...
var HorizontalViewItem = /** @class */ (function (_super) {
    ...
    HorizontalViewItem.prototype.layout = function () {
        this.container.style.width = this.size + "px";
        this.layoutView(1 /* HORIZONTAL */);
    };
    ...
    SplitView.prototype.layoutViews = function () {
        ...
        this.sashItems.forEach(function (_a, index) {
            ...
            if (min && max) {
                ...
                else if (typeof snapAfterIndex === 'number' && !_this.viewItems[snapAfterIndex].visible) {
