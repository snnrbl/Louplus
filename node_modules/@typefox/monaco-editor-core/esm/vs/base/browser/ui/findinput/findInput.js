...
var FindInput = /** @class */ (function (_super) {
    ...
    function FindInput(parent, contextViewProvider, _showOptionButtons, options) {
        ...
        if (_this._showOptionButtons) {
            var paddingRight = (_this.caseSensitive.width() + _this.wholeWords.width() + _this.regex.width()) + 'px';
            _this.inputBox.inputElement.style.paddingRight = paddingRight;
            if (_this.inputBox.mirrorElement) {
                _this.inputBox.mirrorElement.style.paddingRight = paddingRight;
            }
        }
