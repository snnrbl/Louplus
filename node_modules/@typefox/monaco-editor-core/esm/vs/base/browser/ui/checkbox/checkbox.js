...
var CheckboxActionViewItem = /** @class */ (function (_super) {
    ...
    CheckboxActionViewItem.prototype.render = function (container) {
        ...
        this.disposables.add(this.checkbox.onChange(function () { return _this._action.checked = _this.checkbox.checked; }, this));
...
var SimpleCheckbox = /** @class */ (function (_super) {
    ...
    function SimpleCheckbox(title, isChecked) {
        ...
        _this.checkbox = new Checkbox({ title: _this.title, isChecked: _this.isChecked, actionClassName: 'monaco-simple-checkbox' });
