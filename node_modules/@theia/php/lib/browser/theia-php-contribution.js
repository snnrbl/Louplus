...
var PHPClientContribution = /** @class */ (function (_super) {
    __extends(PHPClientContribution, _super);
    function PHPClientContribution(workspace, languages, languageClientFactory) {
    ...
    Object.defineProperty(PHPClientContribution.prototype, "globPatterns", {
        get: function () {
            return [
                '**/*.php'
            ];
    ...
    PHPClientContribution = __decorate([
    ...
    ], PHPClientContribution);
    return PHPClientContribution;
}(browser_1.BaseLanguageClientContribution));
exports.PHPClientContribution = PHPClientContribution;
//# sourceMappingURL=theia-php-contribution.js.map